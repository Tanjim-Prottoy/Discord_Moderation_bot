...
module.exports = {
    name: "set-welcome",
    aliases: ['setw'],
    description: "Set the welcoming system on the server.",
    ...
    run: async (client, message, args) => {
      ...
      db.set(`welcome_system_${message.guild.id}_channel`, channel.id)
      
      const embedDone = new MessageEmbed()
        .setDescription(`${config.emojis.success} Welcome system is now **ready!**`)
        .setTimestamp()
